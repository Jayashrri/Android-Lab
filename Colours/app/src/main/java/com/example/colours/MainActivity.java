...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tRow1.setOnDragListener(dragListener);
        tRow2.setOnDragListener(dragListener);
    ...
    private void setColours() {
        ...
        for(int i=0; i<6; i++) {
            ...
            TextView word = findViewById(tId);
            ViewGroup owner = (ViewGroup) word.getParent();
            owner.removeView(word);
